...
public class ServiceEventHandler extends BaseEventHandler {

    private final IdentityManager identityManager;
    private final ServicesManager servicesManager;

    public ServiceEventHandler(IdentityManager identityManager, ServicesManager servicesManager) {
    ...
    protected Map<Event, Position> analyzePosition(Position position) {
        ...
        for (long serviceId : servicesManager.getAllDeviceItems(position.getDeviceId())) {
            Service service = servicesManager.getById(serviceId);
