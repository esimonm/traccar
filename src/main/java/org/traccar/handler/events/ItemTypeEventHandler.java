...
public class ItemTypeEventHandler extends BaseEventHandler {

    private final IdentityManager identityManager;
    private final ItemTypesManager itemTypesManager;

    public ItemTypeEventHandler(IdentityManager identityManager, ItemTypesManager itemTypesManager) {
        this.identityManager = identityManager;
        this.itemTypesManager = itemTypesManager;
    }
    ...
    protected Map<Event, Position> analyzePosition(Position position) {
        ...
        for (long itemTypeId : itemTypesManager.getAllDeviceItems(position.getDeviceId())) {
            ItemType itemType = itemTypesManager.getById(itemTypeId);
